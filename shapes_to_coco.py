...
ROOT_DIR = 'panel_examples/'
IMAGE_DIR = os.path.join(ROOT_DIR, "tmp_train")
ANNOTATION_DIR = os.path.join(ROOT_DIR, "tmp_label")
...
def main():
    ...
    with open('{}/tmp_coco.json'.format(ROOT_DIR), 'w') as output_json_file:
